...
def custom_run(potential_matrix, time_vector, location_vector, length, resolution, diffusion_dict, folder_to_save, l_runnig_time):
    ...
    rims = Rims(diffusion_dict, potential_profile, l_runnig_time)
    rims.run_rims(l_runnig_time)
